...
<nav class="navbar navbar-expand-lg navbar-light bg-transparent">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/DestinationDelight/welcome_afterlogin.php#aboutus">About Us</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/DestinationDelight/welcome_afterlogin.php#contactus">Contact Us</a>
            </li>
            <li class="nav-item">
