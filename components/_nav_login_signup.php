...
<nav class="navbar navbar-expand-lg navbar-light bg-transparent">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/DestinationDelight/welcome.php#aboutus">About Us</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/DestinationDelight/welcome.php#contactus">Contact Us</a>
            </li>
        </ul>
        <form class="form-inline my-2 my-lg-0">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="login.php">Login/Sign Up <span class="sr-only">(current)</span></a>
                </li>
            </ul>
        </form>
    </div>
